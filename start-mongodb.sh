...
# Fall back to defaults matching action.yml inputs
MONGODB_IMAGE="${MONGODB_IMAGE:-mongo}"
...
MONGODB_REPLICA_SET_HOST="${MONGODB_REPLICA_SET_HOST:-localhost}"
DOCKER_NETWORK="${DOCKER_NETWORK:-}"
DOCKER_NETWORK_ALIAS="${DOCKER_NETWORK_ALIAS:-$MONGODB_CONTAINER_NAME}"
